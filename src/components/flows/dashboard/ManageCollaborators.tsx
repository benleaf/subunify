...
const ManageCollaborators = () => {
    const { deleteCollaborator, updateCollaborator } = useAction()
    ...
    const deleteACollaborator = async () => {
        await deleteCollaborator(properties.selectedProjectId, selectedCollaborator?.id)
        setSelectedCollaborator(undefined)
    }

    const UpdateCollaborator = async () => {
        await updateCollaborator(properties.selectedProjectId, selectedCollaborator?.id, newRole)
        setSelectedCollaborator(undefined)
    }
