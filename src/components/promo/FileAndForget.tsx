...
const Previews = () => <Stack spacing={1}>
    ...
    <FileViewer file={{ bytes: 8900000000, proxyState: 'COMPLETE', created: moment().subtract(44, 'days').toDate(), fileLastModified: new Date(), id: 'test', location: 'DEEP', modified: new Date(), proxyFiles: [], name: 'A001C003_000001.mov', lastFileRestore: moment().add(6, 'hours').toDate() }} thumbnail={C} />
    <FileViewer file={{ bytes: 9000000000, proxyState: 'COMPLETE', created: moment().subtract(44, 'days').toDate(), fileLastModified: new Date(), id: 'test', location: 'DEEP', modified: new Date(), proxyFiles: [], name: 'A001C002_000001.mov', lastFileRestore: moment().subtract(24, 'hours').toDate() }} thumbnail={B} />
...
const PreviewsMedium = () => <Stack spacing={1}>
    ...
    <FileViewer file={{ bytes: 8900000000, proxyState: 'COMPLETE', created: moment().subtract(44, 'days').toDate(), fileLastModified: new Date(), id: 'test', location: 'DEEP', modified: new Date(), proxyFiles: [], name: 'A001C003_000001.mov', lastFileRestore: moment().add(6, 'hours').toDate() }} thumbnail={C} />
    <FileViewer file={{ bytes: 9000000000, proxyState: 'COMPLETE', created: moment().subtract(44, 'days').toDate(), fileLastModified: new Date(), id: 'test', location: 'DEEP', modified: new Date(), proxyFiles: [], name: 'A001C002_000001.mov', lastFileRestore: moment().subtract(24, 'hours').toDate() }} thumbnail={C} />
</Stack>
